...
all_data = pickle.load(open('/mnt/cfs/algorithm/hao.lu/Code/waymo_pre/mmdetection3d/data/waymo/kitti_format/waymo_infos_train.pkl','rb'))
all_calib = np.load('/mnt/cfs/algorithm/hao.lu/Code/waymo_pre/mmdetection3d/calib_train.npy')
...
classes = [
    'car', 'bicycle', 'pedestrian', 'truck', 'bus', 'emergency_vehicle', 'other_vehicle',
     'motorcycle', 'animal'
]
...
with open('/mnt/cfs/algorithm/hao.lu/Code/waymo_pre/mmdetection3d/data/waymo/kitti_format/Uni_waymo_infos_train_v2.pkl', 'wb') as file:
