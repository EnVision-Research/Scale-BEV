...
for cnt, infos in enumerate(list):
    ...
    # gt_boxes[:, 3] = width
    # print(gt_boxes)
    print('lidar2ego_rotation', infos['lidar2ego_rotation'],  Quaternion(list[cnt]['lidar2ego_rotation']).rotation_matrix)
