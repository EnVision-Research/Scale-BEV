...
nusc = NuScenes(version='v1.0-test', dataroot='/mnt/cfs/algorithm/hao.lu/Code/BEVDepth/data/nuScenes/', verbose=True)
...
img_path = '/mnt/cfs/algorithm/hao.lu/Code/BEVDepth/data/nuScenes/' + infos[index]['cam_infos'][cam_names[CAM_index]]['filename']
...
cv2.imwrite('/mnt/cfs/algorithm/hao.lu/Code/BEVDepth/scripts/nus_img.png', img)
