...
def info_transfor(infos_old, max_cam_sweeps=6, max_lidar_sweeps=1):
    ...
    det_3d_path = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/left_stereo/det_3d.json'
    infos_ls = mmcv.load(det_3d_path)
    det_3d_path = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/front/det_3d.json'
    infos_f = mmcv.load(det_3d_path)
    det_3d_path = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/left_45/det_3d.json'
    infos_l45 = mmcv.load(det_3d_path)
    det_3d_path = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/left_90/det_3d.json'
    infos_l90 = mmcv.load(det_3d_path)
    det_3d_path = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/right_45/det_3d.json'
    infos_r45 = mmcv.load(det_3d_path)
    det_3d_path = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/right_90/det_3d.json'
    ...
    for data_frames in infos_old['frames']:  # data_frames=infos_old['frames'][0]
        ...
        for cam_name in cam_names:
            ...
            sweep_cam_info['data_path'] = 'data/SHIFT/Val/' + cam_name + '/' + data_frames['videoName'] + '/' + \
        ...
        for cam_name in cam_names:
            ...
            for ann in data_frames['labels']:
                ...
                box.rotate(Quaternion(matrix=pitch2matrix_shift_box(math.radians(math.radians(ann_info['ego_rotation'])))).inverse)
                ...
                box_yaw = ann_info['orientation'][1] + math.radians(ann_info['word2cam_rotate']) - math.radians(ann_info['ego_rotation'])
...
def main():
    det_3d_path_train = '/mnt/cfs/algorithm/hao.lu/Data/SHIFT/shift-dev/data/discrete/images/val/left_stereo/det_3d.json'
    ...
    mmcv.dump(infos_new, '/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/scripts/PKL/bevdetv2_shift_infos_val_v1.pkl')
