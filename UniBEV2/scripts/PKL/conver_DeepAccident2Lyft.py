...
def add_ann_adj_info(dataset, save_path, dataroot='./data/DeepAccident/'):
    for id in range(len(dataset['infos'])):
        ...
        for cam_name in cam_names:
            ...
            sensor2ego_rotation = [ego2im_Q.x.astype(float), ego2im_Q.y.astype(float), ego2im_Q.z.astype(float),
                                   ego2im_Q.w.astype(float)]
...
if __name__ == '__main__':
    ...
    add_ann_adj_info(dataset=DeepAccident_data, save_path='/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/DeepAccident_data/bevdetv3-DeepAccident_infos_train.pkl')

    DeepAccident_pkl_path = '/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/DeepAccident_data/carla_infos_val.pkl'
    DeepAccident_data = mmcv.load(DeepAccident_pkl_path)
    add_ann_adj_info(dataset=DeepAccident_data, save_path='/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/DeepAccident_data/bevdetv3-DeepAccident_infos_val.pkl')
#
