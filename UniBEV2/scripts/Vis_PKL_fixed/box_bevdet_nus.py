...
infos = mmcv.load('/mnt/cfs/algorithm/hao.lu/Code/BEVDet/data/nuscenes/bevdetv2-nuscenes_infos_val.pkl')
infos = infos['infos']
...
img = cv2.imread('/mnt/cfs/algorithm/hao.lu/Code/BEVDet/'+img_path)
...
cv2.imwrite('/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/scripts/Vis_PKL_fixed/nus_img.png', img)
