...
conda activate FB
cd /mnt/cfs/algorithm/hao.lu/Code/PCBEV_petr
...
# bash ./tools/dist_test.sh ./configs/former/former-r50-cbgs-pc-nus.py ./work_dirs/former-r50-cbgs-pc-nus/epoch_12.pth  8 --eval bbox --out ./work_dirs/petr-r50-cbgs-pc-nus/nus2nus.pkl

bash ./tools/dist_test.sh ./configs/PETR/petr-r50-cbgs-pc-nus.py ./work_dirs/petr-r50-cbgs-pc-nus/epoch_24.pth  8 --eval bbox --out ./work_dirs/bevdepth-r50-cbgs-pc-nus/da2nus.pkl
#
#bash ./tools/dist_test.sh ./configs/former/former-r50-cbgs-pc-nus.py ./work_dirs/former-r50-cbgs-pc-nus/epoch_24.pth  8 --eval bbox --out ./work_dirs/bevdepth-r50-cbgs-pc-nus/da2nus.pkl

# bash ./tools/dist_test.sh ./configs/FB-BEV/fb-r50-cbgs-pc-nus.py ./work_dirs/fb-r50-cbgs-pc-nus/epoch_24.pth  8 --eval bbox --out ./work_dirs/bevdepth-r50-cbgs-pc-nus/da2nus.pkl
