...
# }
classes = [
    'car', 'bicycle', 'pedestrian'#, 'truck', 'construction_vehicle', 'bus', 'trailer', 'barrier', 'motorcycle', 'traffic_cone'
]
...
def add_ann_adj_info(extra_tag):
    ...
    for set in ['train', 'val']:
        ...
        with open('./data/nuscenes/Uni_%s_infos_%s_v2.pkl' % ('nuscenes', set),
                  'wb') as fid:
