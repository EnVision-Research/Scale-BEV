...
def add_ann_adj_info(dataset, save_path, dataroot='./data/DeepAccident/'):
    for id in range(len(dataset['infos'])):
        ...
        dataset['infos'][id]['token'] = info['scenario_type'] + info['vehicle_name'] + info['scene_name']
...
if __name__ == '__main__':
    ...
    add_ann_adj_info(dataset=DeepAccident_data, save_path='/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/DeepAccident_data/Uni_DeepAccident_infos_Train_v2.pkl')

    DeepAccident_pkl_path = '/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/DeepAccident_data/carla_infos_val.pkl'
    DeepAccident_data = mmcv.load(DeepAccident_pkl_path)
    add_ann_adj_info(dataset=DeepAccident_data, save_path='/mnt/cfs/algorithm/hao.lu/Code/BEVDepth_pg/data/DeepAccident_data/Uni_DeepAccident_infos_Val_v2.pkl')
#
