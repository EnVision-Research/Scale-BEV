...
bash ./tools/dist_train.sh  ./configs/Single_BEVDet/bevdet-r50-lyft.py 8
bash ./tools/dist_train.sh  ./configs/Single_BEVDet/bevdet-r50-waymo.py 8
bash ./tools/dist_train.sh  ./configs/Single_BEVDet/bevdet-r50-nus.py 8
