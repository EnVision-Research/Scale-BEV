...
bash ./tools/dist_test.sh  ./configs/Single_FB_BEVFormer_V2/fb-bevformer-r50-da-test.py  \
./work_dirs/fb-bevformer-r50-realsim-v2/epoch_20.pth  8 --eval bbox \
--out ./work_dirs/bevdet-r50-cbgs-NUS2X-intri-nobn/DA2lyft.pkl \
> ./log/realsim_bevformer-r50-uni2da.txt

#bash ./tools/dist_test.sh  ./configs/Single_FB_BEVFormer_V2/fb-bevformer-r50-nus.py  \
#./work_dirs/fb-bevformer-r50-realsim-v2/epoch_20.pth  8 --eval bbox \
#--out ./work_dirs/bevdet-r50-cbgs-NUS2X-intri-nobn/DA2lyft.pkl \
#> ./log/realsim_bevformer-r50-uni2nux.txt


bash ./tools/dist_test.sh  ./configs/Single_FB_V2/fb-r50-da-test.py   \
./work_dirs/fb-r50-realsim-v2/epoch_20.pth  8 --eval bbox   \
--out ./work_dirs/bevdet-r50-cbgs-NUS2X-intri-nobn/DA2lyft.pkl   \
> ./log/realsim_fb-r50-uni2da.txt

#bash ./tools/dist_test.sh  ./configs/Single_FB_V2/fb-r50-nus.py   \
#./work_dirs/fb-r50-realsim-v2/epoch_20.pth  8 --eval bbox  \
#--out ./work_dirs/bevdet-r50-cbgs-NUS2X-intri-nobn/DA2lyft.pkl   \
#> ./log/realsim_fb-r50-uni2nux.txt
