...
bash ./tools/dist_train.sh  ./configs/Single_PDBEV_v2/pdbev-r50-lyft.py 8
bash ./tools/dist_train.sh  ./configs/Single_PDBEV_v2/pdbev-r50-waymo.py 8
bash ./tools/dist_train.sh  ./configs/Single_PDBEV_v2/pdbev-r50-nus.py 8
